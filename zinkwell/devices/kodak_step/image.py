"""Kodak Step image preparation.

Converts images to the format required by Kodak Step printers:
- Kodak Step uses 2x3" Zink paper (same as Canon Ivy 2)
- Final dimensions: 640x1616 pixels
- JPEG compression
"""
...
# Initial scaling target (for quality)
...
def prepare_image(
    ...
    if not preview:
        ...
        # Note: Kodak Step does not require 180-degree rotation like Canon Ivy 2
